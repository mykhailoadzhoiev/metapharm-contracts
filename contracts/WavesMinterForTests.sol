...
contract WavesMinterForTests is Ownable, ReentrancyGuard {
    ...
    uint private constant MAX_PER_WALLET = 3;          // 3

    // max counts for sale
    uint private constant MAX_PIG_PER_PRESALE = 3;     // 1125
    uint private constant MAX_THIEF_PER_PRESALE = 3;   // 1125
    uint private constant MAX_PER_PRESALE = 6;         // 2250

    uint private constant MAX_PIG_PER_WAVE1 = 6;       // 2250
    uint private constant MAX_THIEF_PER_WAVE1 = 6;     // 2250
    uint private constant MAX_PER_WAVE1 = 12;          // 4500

    uint private constant MAX_PIG_PER_WAVE2 = 7;       // 3750
    uint private constant MAX_THIEF_PER_WAVE2 = 7;     // 3750
    uint private constant MAX_PER_WAVE2 = 14;          // 7500

    uint private constant MAX_PIG_PER_WAVE3 = 8;       // 12500
    uint private constant MAX_THIEF_PER_WAVE3 = 8;     // 12500
    uint private constant MAX_PER_WAVE3 = 16;          // 25000

    uint private constant MAX_PIG_PER_GIVEAWAY = 9;    // 13000
    uint private constant MAX_THIEF_PER_GIVEAWAY = 9;  // 13000
    uint private constant MAX_PER_GIVEAWAY = 18;       // 26000

    // ids
    uint private constant MIN_PIG_ID = 0;              // 0
    uint private constant MAX_PIG_ID = 7;              // 12499

    uint private constant MIN_THIEF_ID = 8;            // 12499
    uint private constant MAX_THIEF_ID = 15;           // 24999

    uint private constant MIN_PIG_ID_GIVEAWAY = 16;    // 25000
    uint private constant MAX_PIG_ID_GIVEAWAY = 16;    // 25499

    uint private constant MIN_THIEF_ID_GIVEAWAY = 17;  // 25499
    uint private constant MAX_THIEF_ID_GIVEAWAY = 17;  // 25999

    uint private constant PRESALE_PRICE = 100;         // 1000.00 
    uint private constant FIRST_WAVE_PRICE = 125;      // 1250.00
    uint private constant SECOND_WAVE_PRICE = 150;     // 1500.00
    uint private constant THIRD_WAVE_PRICE = 175;      // 1750.00
